...
#include "Modem.h"
  ...
  #define PRODUCT_CARDPUTER_ADV 0xEC // M5Stack Cardputer Adv + Cap LoRa-1262
  #define BOARD_CARDPUTER_ADV   0x43
  #define MODEL_EC              0xEC // Cardputer Adv, 850-950 MHz
  ...
  #define VALIDATE_FIRMWARE true
    ...
    #define PIN_GPS_RX 34
      ...
      const int pin_reset = 3;
      const int pin_sclk = 40;
      const int pin_mosi = 14;
      const int pin_miso = 39;
      const int pin_tcxo_enable = -1;
      const int pin_dio = 4;
      const int pin_busy = 6;
      #define CARDPUTER_ADV_I2C_SDA 8
      #define CARDPUTER_ADV_I2C_SCL 9
      #define CARDPUTER_ADV_CAP_IOE_ADDR 0x43
      #define CARDPUTER_ADV_CAP_RF_SW_PIN 0
